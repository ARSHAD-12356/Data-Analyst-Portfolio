...
export function About() {
  ...
  return (
    <section id="about" className="py-20 px-4 bg-muted/20" ref={sectionRef}>
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="inline-block px-4 py-2 rounded-full glass border border-primary/30 mb-2">
            <p className="text-sm text-primary font-medium">Get to know me</p>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold text-foreground font-heading">About Me</h2>
        ...
        <div className="grid lg:grid-cols-5 gap-8 mb-12">
          ...
          >
            <Card className="p-8 glass border-border hover:border-primary/50 transition-all duration-300 h-full">
              <h3 className="text-2xl font-semibold mb-4 text-foreground font-heading">Professional Summary</h3>
          ...
          >
            <div className="relative w-full max-w-md">
              ...
              <Card className="relative p-8 glass border-primary/20 overflow-hidden hover:scale-105 transition-transform duration-500">
                <div className="aspect-square rounded-2xl overflow-hidden mb-6 group">
                  <img
                    src="/male-analyst-working.jpg"
                    alt="Data Analysis"
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                  />
                </div>
                <h3 className="text-xl font-semibold text-foreground mb-2">Analytical Thinking</h3>
